...
const Form = styled("form")(() => ({display: "flex", flexDirection: "column", justifyContent: "center", textAlign: "end", marginTop:"7rem"}));
...
const SearchBar = () => {
    ...
    const onSubmit = e => {
        ...
        if (!origin) { // can use client location as default
        ...
        <Grid container flexDirection='column' justifyContent='center' alignItems='flex-end'>
            <Form onSubmit={onSubmit}>
                <div>
                    ...
                    <StyledInputBase placeholder='תל אביב'
                        value={origin}
                        onChange={
                ...
                <div>
                    ...
                    <StyledInputBase placeholder='המכללה למנהל'
                        value={destination}
                        onChange={
